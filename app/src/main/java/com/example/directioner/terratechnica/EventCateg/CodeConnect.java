...
public class CodeConnect extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setListAdapter(new EventsAdapter(getActivity(), R.layout.event_list_cards, EventsDataManager.dataFetch("code")));
...
//        Toast.makeText(getActivity(), ((TextView) v.findViewById(R.id.event_name)).getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        bundle.putString(GlobalData.EVENT_CATEG, "code");
